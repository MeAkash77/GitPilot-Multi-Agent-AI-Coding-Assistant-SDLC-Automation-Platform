    ...
    >
      ...
      >
        ...
        <div style={{ padding: "8px 32px 0" }}>
          ...
          >
            ...
            <MetaRow
              ...
              value={
                <a
                  href="https://github.com/MeAkash77/GitPilot-Multi-Agent-AI-Coding-Assistant-SDLC-Automation-Platform"
                  target="_blank"
        ...
        >
          ...
          />
          <ActionButton
            href="https://github.com/MeAkash77/GitPilot-Multi-Agent-AI-Coding-Assistant-SDLC-Automation-Platform#readme"
            icon={<DocsIcon />}
            label="Docs"
          />
          <ActionButton
            href="https://github.com/MeAkash77/GitPilot-Multi-Agent-AI-Coding-Assistant-SDLC-Automation-Platform/issues"
            icon={<BugIcon />}
            label="Report"
          />
        </div>
